...
class Auth extends CI_Controller {
	...
	public function create_user()
    {
        ...
        $this->form_validation->set_rules('date_of_birth', $this->lang->line('create_user_validation_date_of_birth_label'), 'trim');
	...
	public function edit_user($id)
	{
		...
		$this->form_validation->set_rules('last_name', $this->lang->line('edit_user_validation_lname_label'), 'required');
                $this->form_validation->set_rules('date_of_birth', $this->lang->line('edit_user_validation_date_of_birth_label'), 'required');
